...
export const metadata: Metadata = {
  title: "درباره ما",
  description: "آشنایی با وثیق، پلتفرم واسط آگهی خرید و فروش وام در ایران.",
...
const values = [
  {
    icon: ShieldCheck,
    title: "شفافیت",
    desc: "ما همواره به‌روشنی اعلام می‌کنیم که وثیق صرفاً واسط آگهی است، نه ارائه‌دهنده مستقیم خدمات مالی.",
  },
  {
    icon: Users,
    title: "کاربرمحوری",
    desc: "تجربه کاربری ساده و پشتیبانی پاسخگو، محور طراحی تمام بخش‌های وثیق بوده است.",
  },
  {
    icon: TrendingUp,
    title: "رشد مستمر",
...
export default function AboutUsPage() {
  return (
    <div className="container-page max-w-3xl py-8">
      ...
      <h1 className="mb-4 text-2xl font-extrabold text-neutral-900">درباره وثیق</h1>

      <div className="space-y-4 text-sm leading-8 text-neutral-600">
        <p>
          وثیق با هدف ساده‌سازی فرآیند خرید و فروش وام در ایران راه‌اندازی شده است. بسیاری از
          افراد به دلیل نیاز مالی، مایل به فروش وام دریافتی خود هستند و در مقابل، افراد بسیاری به
          دنبال خرید وام با شرایط مناسب می‌گردند. وثیق این دو گروه را در بستری منظم، شفاف و قابل
          جستجو کنار هم قرار می‌دهد.
        </p>
        <p>
          پلتفرم ما آگهی‌ها را بر اساس شهر، بانک و نوع وام دسته‌بندی می‌کند تا کاربران بتوانند در
          کوتاه‌ترین زمان ممکن، گزینه مناسب خود را پیدا کنند. تأکید می‌کنیم که وثیق صرفاً یک واسط
